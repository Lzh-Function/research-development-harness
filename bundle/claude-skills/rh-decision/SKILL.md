---
name: rh-decision
description: Run a Deviation Gate and record the researcher's decision when the meaning of the work changes: research question, target, label or dataset definition, experimental validity, metric semantics, major architecture, persistent API, material scope expansion, large added compute cost, or interpretation. Use before implementing any such change.
---

# RDH Decision

Escalate a semantic deviation to the researcher and record the outcome.
...
3. Read the canonical workflow and follow it:
   ...
   - `.research-harness/workflows/decision.md`
