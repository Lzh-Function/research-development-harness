---
name: rh-finish
description: Synthesise the Draft PR from durable records, run the Knowledge Gate, and check the deterministic READY_TO_MERGE preconditions. Use when the work unit is believed complete. The harness never merges.
---

# RDH Finish

Bring a work unit to READY_TO_MERGE — and stop there.
...
3. Read the canonical workflow and follow it:
   ...
   - `.research-harness/workflows/finish.md`
